...
public class GreetingsController {
	...
	@ResponseBody /* <- Retorna os dados para o corpos da resposta */
	public ResponseEntity<List<Usuario>> listaUsuario() {

		List<Usuario> usuarios = usuarioRepository.findAll(); /* Executa da consulta no banco de dados */
	...
	public ResponseEntity<List<Usuario>> buscarPorNome(@RequestParam(name = "name") String name) {
		...
		List<Usuario> usuario = usuarioRepository.buscarPorNome(name.trim()
				.toUpperCase());/*
								 * .trim tira o espaço .toUpperCase() ignora o maiusculo e minusculo na busca
								 */
